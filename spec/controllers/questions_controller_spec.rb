...
RSpec.describe QuestionsController, type: :controller do
  ...
  describe 'authorized user' do
    ...
    describe 'GET #new' do
      ...
      it 'assigns a new link to a new question' do
    ...
    describe 'PATCH #subscribe' do
      context 'user is the author of question' do
        ...
        it 'adds subscription to author of the question' do
          expect { post :create, params: { question: attributes_for(:question) }, format: :js}.to change(user.subscriptions, :count).by(1)
        end
      end
      ...
      context 'user is not the author of question' do
        ...
        it 'allows to subscribe to question' do
          expect { patch :subscribe, params: { id: question.id }, format: :js}.to change(Subscription, :count).by(1)
        end
